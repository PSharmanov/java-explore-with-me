...
class StatsControllerTest {
    ...
    void saveTest() throws Exception {
        ...
        when(statService.addHit(any())).thenReturn(endpointHitDto);
    ...
    void getTest() throws Exception {
        ...
        when(statService.getStats(any(), any(), anyList(), anyBoolean())).thenReturn(viewStatsDtoList);
    ...
    void getTestWithWrongDates() throws Exception {
        when(statService.getStats(any(), any(), anyList(), anyBoolean()))
                .thenThrow(new RequestException("Дата начала позже даты окончания!"));
        ...
        mvc.perform(get("/stats")
                ...
                .andExpect(result -> assertInstanceOf(RequestException.class, result.getResolvedException()))
